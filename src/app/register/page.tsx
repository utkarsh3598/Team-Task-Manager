...
import { UserPlus, KeyRound, Mail, User, ShieldCheck, AlertCircle, Loader2 } from 'lucide-react';
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`py-3 px-4 border rounded-xl flex items-center justify-center gap-2 cursor-pointer transition-all text-sm font-medium ${
                  role === 'MEMBER'
            ...
            <p className="text-[11px] text-slate-500 mt-2 text-center">
              Admins can create projects & tasks; Members can view & update statuses.
            </p>
          </div>
